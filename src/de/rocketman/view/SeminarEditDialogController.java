    ...
    private boolean isInputValid() {
        ...
        if (anzahlTageField.getText() == null || anzahlTageField.getText().length() == 0) {
            ...
            try {
                ...
                errorMessage += "Keine gültige Anzahl der Tage (muss ganzzahlig sein)!\n";
            }
        }
        ...
        if (errorMessage.length() == 0) {
            ...
            alert.setHeaderText("Bitte korrigieren Sie die ungültigen Einträge oder drücken Sie auf abbrechen!");
